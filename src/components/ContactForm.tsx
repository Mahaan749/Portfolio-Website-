    ...
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit} aria-busy={loading}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          As an ethical cybersecurity student, I have to say: <strong className="font-bold text-white dark:text-white">Please don&apos;t include passwords, credentials, or sensitive system details.</strong> But even if you do, I won&apos;t tell anyone. Pinky promise! 🤫
        </p>
      </div>
      <Button
        disabled={loading}
