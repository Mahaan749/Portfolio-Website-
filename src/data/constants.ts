...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2024",
    endDate: "Present",
    title: "BSc (Hons) Ethical Hacking and Cyber Security",
    company: "Softwarica College of IT & E-Commerce · Coventry University",
    description: [
      "Fourth-semester student.",
      "Coursework includes networking, Windows and Linux, web technologies and authorised security testing.",
      "Interested in security operations, incident triage, risk, policy and compliance.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    company: "TryHackMe · Red Team Leaders · ISC2",
    description: [
      "TryHackMe Pre Security Learning Path.",
      "Foundations of Log Analysis for Cyber Defense.",
      "Certified LLM Security Professional course.",
      "ISC2 Certified in Cybersecurity coursework completed; exam preparation in progress.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.VUE,
